...
const en = {
  ...
  tech7l: "Watchtower",
  tech7d: "Once both sides are funded, each party pre-signs a fee-laddered claim and a refund and hands them to the coordinator, which finishes or refunds the swap even if you close your tab. Every pre-signed transaction pays only its own owner.",
  tech8l: "Safe abort",
...
const zh = {
  ...
  tech7l: "看守塔",
  tech7d: "双方充值后，每一方都预先签好一份带手续费梯度的领取交易和一份退款交易并交给协调器，即使您关闭页面，协调器也能完成或退款。每一笔预签名交易都只支付给其自身的所有者。",
  tech8l: "安全中止",
