...
const en = {
  ...
  heroSub: "Find a counterparty and agree a price, then settle a peer-to-peer cross-chain atomic swap. Non-custodial — your keys are generated in your browser and never leave it.",
  ...
  feat2: "Non-custodial", feat2d: "Keys are generated in your browser and never leave. The coordinator holds no funds or keys.",
...
const zh = {
  ...
  heroSub: "找到对手方并商定价格，即可完成点对点的跨链原子兑换。非托管——您的密钥在浏览器中生成，绝不离开。",
  heroStart: "开始兑换", heroLearn: "工作原理",
  featTitle: "从设计上即无需信任",
  feat1: "无需信任的原子兑换", feat1d: "要么双方都完成，要么双方都退款——任何一方都无法被欺骗。",
  feat2: "非托管", feat2d: "密钥在您的浏览器中生成且绝不离开。协调器不持有任何资金或密钥。",
