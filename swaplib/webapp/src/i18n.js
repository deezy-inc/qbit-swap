...
const en = {
  ...
  haveBtc: "I have BTC  →  I want QBT", haveBtcSub: "You send Bitcoin, receive Qbit",
  haveQbt: "I have QBT  →  I want BTC", haveQbtSub: "You send Qbit, receive Bitcoin",
  ...
  confirmP1: "You'll swap {from} for {to} directly with someone who wants the opposite side. Find that person and agree the amounts and price with them first — this tool only coordinates the swap and never holds your funds or keys.",
...
const zh = {
  ...
  haveBtc: "我有 BTC  →  我想要 QBT", haveBtcSub: "您发送比特币，接收 Qbit",
  haveQbt: "我有 QBT  →  我想要 BTC", haveQbtSub: "您发送 Qbit，接收比特币",
  ...
  confirmP1: "您将与想要相反方向的人直接把 {from} 兑换为 {to}。请先找到对方并商定数量和价格——本工具只负责协调兑换，绝不持有您的资金或密钥。",
